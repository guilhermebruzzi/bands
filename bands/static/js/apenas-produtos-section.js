...
function mainApenasProdutosSection(){
    ...
    if(produtosSection){
        ...
        produtosSection.innerHTML += '<footer style="width: 780px; margin: 50px 0 30px 0;">Quer saber de shows e produtos de outras bandas? Acesse o <a target="_blank" href="http://bands.com.br"><img src="http://bands.com.br/static/img/logoBands.jpg" style="width: 64px; height: 50px; position: relative; top: 10px;"></a></footer>';
